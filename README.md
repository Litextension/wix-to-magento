# wix-to-magento
=== WIX to Magento 1.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/shopping-cart-migration/wix-to-magento.html

== Description: WIX to Magento 1.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from WIX to Magento 1.x automatically.
